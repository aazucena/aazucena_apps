...
- All shared project context (structure, commands, architecture, conventions, roadmap, status) lives in a single source of truth: @docs/CONTEXT.md — read it. When updating project context, update that file only; do not duplicate content here.
