...
export const ButtonVariantEnum = z.enum([
  'primary', 'secondary', 'outline', 'ghost'
]);

export const ButtonSizeEnum = z.enum([
  'sm', 'md', 'lg'
]);

export const FooterVariantEnum = z.enum([
  'default', 'minimal'
]);

export const ThemeModeEnum = z.enum([
...
export const ProjectDisplayEnum = z.enum([
  'hidden', 'unlisted', 'standard', 'featured', 'home'
]);

export const ProjectTypeEnum = z.enum([
  'Web App', 'Mobile App', 'Desktop App', 'Library', 'API', 'CLI Tool', 'Game', 'Music Production', 'Hardware/Embedded'
]);
...
export const EducationTypeEnum = z.enum([
  'high-school', 'diploma', 'associate', 'bachelor', 'master', 'doctorate', 'certificate', 'bootcamp', 'online-course'
]);

export const EducationDisplayEnum = z.enum([
  'hidden', 'standard', 'featured'
]);

export const AvailabilityStatusEnum = z.enum([
  'Open to Opportunities', 'Busy / Working on Projects', 'On Break / Personal Time', 'Looking for Collaborations', 'Unavailable'
]);

export const IndustryEnum = z.enum([
  'Technology', 'Finance', 'Healthcare', 'Education', 'Entertainment', 'Retail', 'Manufacturing', 'Government', 'Non-Profit', 'Startup', 'Food & Beverage', 'Oil & Gas', 'Media'
]);
...
export const PageTemplateEnum = z.enum([
  'legal', 'default', 'landing'
]);

export const SkillDisplayEnum = z.enum([
...
export const CategoryDisplayEnum = z.enum([
  'hidden', 'visible'
]);
...
export const ChallengeTypeEnum = z.enum([
  'Hidden Keyword', 'Secret Page', 'Konami Code', 'Scroll Pattern', 'Time Based', 'Interactive Element'
]);
...
export const PreloaderVariantEnum = z.enum([
  'interactive', 'simple'
]);

export const AriaLiveEnum = z.enum([
...
export const TwitterCardEnum = z.enum([
  'summary', 'summary_large_image', 'app', 'player'
]);

export const OpenGraphTypeEnum = z.enum([
...
export const SocialPlatformEnum = z.enum([
  'GitHub', 'LinkedIn', 'Twitter', 'YouTube', 'Instagram', 'Facebook', 'TikTok', 'Discord', 'Twitch', 'Mastodon'
]);
