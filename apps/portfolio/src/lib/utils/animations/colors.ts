...
export function getBadgeClasses(gradient: string): string {
  ...
  const colorMap: Record<string, string> = {
    'from-cyan-400 to-blue-500': 'bg-cyan-400/20 text-cyan-400 border border-cyan-400/30 hover:bg-cyan-400/30',
    'from-purple-400 to-pink-500': 'bg-purple-400/20 text-purple-400 border border-purple-400/30 hover:bg-purple-400/30',
    'from-green-400 to-emerald-500': 'bg-green-400/20 text-green-400 border border-green-400/30 hover:bg-green-400/30',
    'from-blue-400 to-indigo-500': 'bg-blue-400/20 text-blue-400 border border-blue-400/30 hover:bg-blue-400/30',
    'from-yellow-400 to-orange-500': 'bg-yellow-400/20 text-yellow-400 border border-yellow-400/30 hover:bg-yellow-400/30',
    'from-pink-400 to-red-500': 'bg-pink-400/20 text-pink-400 border border-pink-400/30 hover:bg-pink-400/30'
  };
