...
export type TagColor = 'cyan' | 'purple' | 'green' | 'orange' | 'blue' | 'pink' | 'yellow' | 'gray' | 'teal' | 'red';
...
export function isValidTagColor(color?: string): color is TagColor {
  const validColors: TagColor[] = ['cyan', 'purple', 'green', 'orange', 'blue', 'pink', 'yellow', 'gray', 'teal', 'red'];
...
export function getAllTagColors(): TagColor[] {
  return ['cyan', 'purple', 'green', 'orange', 'blue', 'pink', 'yellow', 'gray', 'teal', 'red'];
}
