...
import type { HeatmapCell } from "~/lib/transformers/journey";
...
export function Heatmap({ data }: HeatmapProps) {
  ...
  const years = useMemo(() => {
    return Array.from(
      new Set(filteredData.map((d) => d.date.getFullYear())),
    ).sort((a, b) => a - b);
  }, [filteredData]);
  ...
  useEffect(() => {
    ...
    g.selectAll(".year-label")
      ...
      .enter()
      .append("text")
      .attr("x", (d, _i) => years.indexOf(d) * cellSize + cellSize / 2)
      .attr("y", -10)
                ...
                >
                  ...
                  <div className="flex-1 space-y-4">
                    <p className="text-xs leading-relaxed text-gray-500 dark:text-gray-400">
                      This heatmap visualizes technical activity over time. Each
                      cell represents a month.
                    </p>
