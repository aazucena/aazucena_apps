      ...
      >
        ...
        <div className="fixed top-8 right-8 z-50 flex flex-row gap-4 bg-black/30 backdrop-blur-md border border-white/20 rounded-full px-4 py-3">
          ...
          <button
            ...
            className={`group relative w-14 h-14 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 ${
              isSoundMuted
                ? 'bg-red-500/20 border border-red-400/40 hover:bg-red-500/30 hover:border-red-400/60'
