...
import { SocialMenu, SettingsPanel, InfoPanel, ToolbarButton } from '~/components/ui';
import { Popover } from '~/components/ui/common';
import type { AtmosphericPhase } from '~/config/animations';
import { usePortfolio, useAnimation, usePortfolioData } from '~/contexts/animations';
 ...
 */
export function NavigationToolbar({ currentPhase }: NavigationToolbarProps): JSX.Element {
