  ...
  return (
    <>
      ...
      {opacities.thermosphere > 0 && (
        <Suspense fallback={null}>
          <ThermosphereLazy opacity={opacities.thermosphere} />
        </Suspense>
      )}
      ...
      {opacities.mesosphere > 0 && (
        <Suspense fallback={null}>
          <MesosphereLazy opacity={opacities.mesosphere} />
        </Suspense>
      )}
      ...
      {opacities.stratosphere > 0 && (
        <Suspense fallback={null}>
          <StratosphereLazy clouds={clouds} opacity={opacities.stratosphere} />
        </Suspense>
      )}
