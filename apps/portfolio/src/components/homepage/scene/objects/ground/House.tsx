  ...
  return (
    <group>
      ...
      <mesh position={[0, 1.2, 0]} rotation={[0, Math.PI / 4, 0]}>
        ...
        <meshStandardMaterial color={roofColor} roughness={0.7} transparent opacity={opacity} />
      </mesh>

      {/* Door */}
      <mesh position={[0, 0.35, 0.51]}>
        <boxGeometry args={[0.3, 0.6, 0.02]} />
        <meshStandardMaterial color="#654321" roughness={0.9} transparent opacity={opacity} />
      </mesh>

      {/* Windows */}
      <mesh position={[-0.3, 0.6, 0.51]}>
        <boxGeometry args={[0.2, 0.2, 0.02]} />
        <meshStandardMaterial color="#87CEEB" transparent opacity={0.7 * opacity} emissive="#87CEEB" emissiveIntensity={0.2} />
      </mesh>
      <mesh position={[0.3, 0.6, 0.51]}>
        <boxGeometry args={[0.2, 0.2, 0.02]} />
        <meshStandardMaterial color="#87CEEB" transparent opacity={0.7 * opacity} emissive="#87CEEB" emissiveIntensity={0.2} />
