...
export function SpaceDebris({
  ...
  const animationParams = {
    ...
    "damaged-panel": {
      ...
      circular: {
        x: { frequency: 0.25, amplitude: 0.4 },
    ...
    "body-piece": {
      ...
      circular: {
        x: { frequency: 0.28, amplitude: 0.6 },
        y: { frequency: 0.25, amplitude: 0.4 },
      },
    },
    antenna: {
      rotation: { x: 0.12, y: 0.28, z: 0.18 },
      circular: {
        x: { frequency: 0.22, amplitude: 0.35 },
        y: { frequency: 0.35, amplitude: 0.45 },
      },
    },
  };
  ...
  return <group ref={debrisRef}>{renderDebris()}</group>;
}
