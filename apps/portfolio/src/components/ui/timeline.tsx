...
>(({ className, variant = "default", ...props }, ref) => {
  const variantStyles = {
    ...
    success: "bg-gradient-to-br from-green-400 to-emerald-500 shadow-lg shadow-green-400/50",
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "absolute left-[11px] top-1/2 h-full w-0.5 bg-gradient-to-b from-cyan-400/50 via-cyan-400/30 to-transparent",
      className
    )}
    {...props}
  />
