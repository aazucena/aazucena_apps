...
export function InteractiveCard({ 
  ...
  return (
    ...
    >
      ...
      >
        <div className={`flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center ${color} transition-transform duration-500 group-hover:scale-110`}>
          <Icon size={24} />
        </div>
        <div className="flex-grow pt-1">
          ...
          {subtitle && <p className="text-xs font-black uppercase tracking-widest text-blue-600 dark:text-blue-400 mt-1">{subtitle}</p>}
        </div>
      </button>
