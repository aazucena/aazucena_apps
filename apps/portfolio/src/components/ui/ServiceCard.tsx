...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    <div className="group flex flex-col gap-5 rounded-3xl border border-gray-100 bg-gray-50/50 p-8 transition-all hover:border-blue-500/20 dark:border-gray-800 dark:bg-gray-900/30">
