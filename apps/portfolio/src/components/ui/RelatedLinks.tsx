...
import { ExternalLink, getIconComponent } from "@aazucena/icons";
...
export function RelatedLinks({
  ...
  return (
    <div
      className={`rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800 ${className}`}
    >
