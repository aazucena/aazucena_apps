...
const journeyData = {
  header: {
    title: 'The Evolution.',
    description:
      'An interactive report on growth, technical adaptation, and the logic behind the journey.',
    watermark: 'JOURNEY',
    accentColor: '#3b82f6',
  },
  phases: [
      ...
      items: [
        {
          ...
          description: 'Mastering algorithms, data structures, and system design.',
          variant: 'blue',
        },
      ],
    },
      ...
      items: [
        {
          ...
          description: 'Adopting React and Node.js for modern web architectures.',
          variant: 'purple',
        },
      ],
    },
