 ...
 */
export const mainClickhouseClient = globalForClickHouse.mainClickhouseClient || createClient({
 ...
 */
export const ingestClickhouseClient = globalForClickHouse.ingestClickhouseClient || createClient({
  host: process.env.CLICKHOUSE_HOST || 'http://localhost:8123',
...
export const plausibleClickhouseClient = globalForClickHouse.plausibleClickhouseClient || createClient({
