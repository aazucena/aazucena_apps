...
export function CommandPalette() {
  ...
  const onSelect = useCallback((action: CommandAction) => {
    setOpen(false);
        ...
        <Command.List className="max-h-[400px] overflow-y-auto p-2 custom-scrollbar">
          <Command.Empty className="py-12 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-xs font-mono text-zinc-500 uppercase tracking-widest">No_Results_Found</p>
            </div>
          </Command.Empty>
                ...
                {actionsInCategory.map((action) => (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col">
                      ...
                      <span className="text-[10px] font-mono text-zinc-500 truncate">{action.keywords}</span>
                    </div>
          ...
          <Command.Group heading="AI Assistant" className="px-2 pt-4 pb-2 border-t border-zinc-100 dark:border-zinc-800 mt-2">
             <div className="mb-2 px-2">
        ...
        <div className="px-4 py-3 bg-zinc-50 dark:bg-zinc-950/50 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
          <div className="flex items-center gap-4 text-[10px] font-mono text-zinc-500">
            <div className="flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 rounded border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-300 font-bold">↵</kbd>
              <span>to select</span>
            </div>
            <div className="flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 rounded border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-300 font-bold">↑↓</kbd>
