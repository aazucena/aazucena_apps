...
export const StatusBadge: FC<StatusBadgeProps> = ({
  ...
  const variantClasses = {
    ...
    secondary:
      'bg-secondary-50 text-secondary-700 border-secondary-100 dark:bg-secondary-900/20 dark:text-secondary-400 dark:border-secondary-900/50',
  };
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-xl font-black uppercase tracking-widest border ${variantClasses[variant]} ${sizeMap[size]} ${className}`}
    >
