    ...
    <div className="relative h-full flex items-center">
      ...
      >
        <div className="text-right hidden sm:block">
          <div className="text-[10px] font-black text-zinc-900 dark:text-zinc-100 tracking-tight leading-none uppercase group-hover:text-primary-500 transition-colors">AZUCENA_ROOT_AUTH</div>
          <div className="text-[8px] font-mono text-primary-600 mt-1 uppercase tracking-widest font-bold opacity-80 group-hover:opacity-100">PRIVILEGED_EXECUTION</div>
        </div>
        <div className={cn(
          ...
          isOpen ? "border-primary-500/50 ring-2 ring-primary-500/10" : "border-zinc-200 dark:border-zinc-800"
        )}>
            ...
            >
              ...
              <div className="p-5 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs font-black text-zinc-900 dark:text-zinc-100 uppercase tracking-tighter text-left">Session_Identity</div>
              ...
              <div className="p-2">
                {menuItems.map((item) => (
                  ...
                  >
                    <div className={cn("w-8 h-8 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform", item.color)}>
                      <item.icon size={16} />
                    </div>
                    <div>
                      <div className="text-[11px] font-bold text-zinc-900 dark:text-zinc-100 uppercase tracking-tight">{item.label}</div>
                      <div className="text-[9px] font-mono text-zinc-400 dark:text-zinc-600 uppercase">{item.sub}</div>
                    </div>
                  </button>
                ))}
              </div>
