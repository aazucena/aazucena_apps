...
const EVENT_CONFIG: Record<
  string,
  { icon: any; color: string; dot: 'primary' | 'success' | 'warning' | 'danger' | 'default' }
> = {
  ...
  return (
    <div className={cn('relative', !scrollable && 'h-full')}>
      ...
      <div
        className={cn(
          scrollable &&
            'overflow-y-auto transition-all duration-500 scrollbar-thin scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-800',
