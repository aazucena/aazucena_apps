  ...
  return (
    <div className="w-full relative bg-zinc-950 border border-zinc-800 rounded-[2.5rem] overflow-hidden shadow-2xl">
      <div className="absolute top-8 left-8 z-10">
        <h3 className="text-xs font-black text-zinc-100 uppercase tracking-[0.3em]">Geospatial_Identity_Map</h3>
        <p className="text-[10px] text-zinc-500 font-mono mt-1 uppercase tracking-widest">Global Reach Intelligence</p>
      </div>
      ...
      <AnimatePresence>
        {hoveredCountry && (
          ...
          >
            <div className="text-[10px] font-black text-primary-500 uppercase tracking-widest mb-1">{hoveredCountry.name}</div>
            <div className="text-xl font-black text-white font-mono tracking-tighter">
              {hoveredCountry.count.toLocaleString()} <span className="text-[10px] text-zinc-500 uppercase tracking-normal">Signals</span>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="absolute bottom-8 left-8 flex flex-col gap-2">
        <div className="text-[8px] font-black text-zinc-500 uppercase tracking-widest">Engagement_Density</div>
