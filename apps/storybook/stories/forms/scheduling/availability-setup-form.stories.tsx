...
export const WithDefaultValues: Story = {
  args: { variant: 'default', defaultValues: { timezone: 'America/New_York', weekdays: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri'], startTime: '09:00', endTime: '17:00', bufferBetween: '15', advanceNotice: 24, maxPerDay: 5 } },
};
