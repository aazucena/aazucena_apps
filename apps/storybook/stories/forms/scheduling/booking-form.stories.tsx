...
const meta = {
  ...
  parameters: { layout: 'centered', docs: { description: { component: 'Two-step booking wizard: select service + time slot, then provide contact details.' } } },
  tags: ['autodocs'],
...
export const CustomServices: Story = { args: { variant: 'default', serviceTypes: ['Portfolio Review', 'System Design', 'Career Coaching', 'Music Collab'] } };
