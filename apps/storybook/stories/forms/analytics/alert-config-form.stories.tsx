...
const meta = {
  ...
  parameters: { layout: "centered", docs: { description: { component: "Create monitoring alerts: metric, threshold, operator, and notification channel." } } },
  tags: ["autodocs"],
...
export const WithCustomMetrics: Story = { args: { variant: "default", availableMetrics: ["http_errors", "db_latency", "queue_depth"] } };
