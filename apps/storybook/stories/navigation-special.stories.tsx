...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'High-level navigation patterns for deep links, table of contents, and directional item-to-item movement.',
      },
    },
  },
  ...
  render: () => (
    <div className="p-20 grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
      <LinkMenu variant="card">
        <LinkMenuHeader><LinkMenuTitle>Project_Resources</LinkMenuTitle></LinkMenuHeader>
        <LinkMenuList>
          <LinkMenuItem>
            <LinkMenuLink href="#">
      ...
      <LinkMenu variant="cyber">
        <LinkMenuHeader><LinkMenuTitle variant="cyber">// EXTERNAL_NODES</LinkMenuTitle></LinkMenuHeader>
        <LinkMenuList>
          <LinkMenuItem>
            <LinkMenuLink variant="cyber" href="#">
              <LinkMenuIcon variant="cyber"><Twitter /></LinkMenuIcon>
              <LinkMenuContent>
                <LinkMenuLabel className="font-mono text-cyan-400">SIGNAL_STREAM</LinkMenuLabel>
                <LinkMenuDescription className="font-mono italic text-[10px]">Real-time telemetry broadcasts.</LinkMenuDescription>
              </LinkMenuContent>
            </LinkMenuLink>
          </LinkMenuItem>
        </LinkMenuList>
  ...
  render: () => (
    <div className="p-20 space-y-20 max-w-6xl mx-auto">
      <div className="space-y-4">
        <h4 className="text-[10px] font-black uppercase tracking-widest opacity-40">Standard_Pattern</h4>
        <DetailNavigation 
          basePath="/projects"
      ...
      <div className="space-y-4">
        <h4 className="text-[10px] font-mono italic uppercase tracking-widest text-cyan-500/60">// CYBER_STREAM</h4>
        <DetailNavigation 
          variant="cyber"
          basePath="/nodes"
  ...
  render: () => (
    <div className="p-20 space-y-12 flex flex-col items-start max-w-6xl mx-auto">
      <div className="flex gap-12 items-center">
        ...
        <ArrowLink variant="cyber" href="#">ESTABLISH_UPLINK</ArrowLink>
      </div>
