...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A wrapper component that applies consistent typographic styles to nested HTML content. Ideal for blog posts, documentation, and legal pages.',
      },
    },
  },
  tags: ['autodocs'],
...
const sampleContent = (
  <>
    ...
    <p>
      Exploring the <strong>neural-adaptive</strong> landscape of modern interfaces. This system
      leverages high-fidelity telemetry to establish real-time node synchronization across
      distributed continental sectors.
    </p>
    ...
    <blockquote>
      "The future of computing is not in the hardware, but in the seamless ingestion of human
      intent."
    </blockquote>
  </>
);
  ...
  args: {
    ...
    children: (
      <>
        ...
        <p>
          This document outlines the security procedures for local data persistence within the
          Azucena architecture.
        </p>
        <h2>1. Data_Collection</h2>
        <p>
          We do not collect personal identifiers. All telemetry is anonymized at the edge node
          before ingestion.
        </p>
        <h2>2. Encryption</h2>
        <p>
          All stored payloads are encrypted using AES-256-GCM standards with keys rotated every 24
          hours.
        </p>
      </>
    ),
    ...
    <div className="space-y-12">
      <div className="space-y-4">
        ...
        <Prose size="sm" className="w-[600px] border p-6 rounded-xl">
          <p>
            The neural telemetry engine is reporting optimal pulse intervals across all active nodes
            in the US_EAST sector.
          </p>
        </Prose>
      </div>
      <div className="space-y-4">
