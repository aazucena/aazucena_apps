...
export const Basic: Story = {
  render: () => (
    <Dock>
      ...
      <DockItem label="Mail"><MailIcon /></DockItem>
...
export const Cyber: Story = {
  render: () => (
    <Dock variant="cyber">
      <DockItem label="HOME"><HomeIcon /></DockItem>
      <DockItem label="SCAN"><SearchIcon /></DockItem>
      <DockItem label="COMMS"><MailIcon /></DockItem>
      <DockItem label="IDENT"><UserIcon /></DockItem>
      <DockItem label="CONFIG"><SettingsIcon /></DockItem>
    </Dock>
  ),
};
