...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A comprehensive layout system for site-wide footers. Supports multi-column navigation, social links, tech stack displays, and status indicators.',
      },
    },
  },
  tags: ['autodocs'],
      ...
      <FooterContent>
        <FooterGrid>
          <FooterSection>
            ...
            <p className="text-sm opacity-60 max-w-xs leading-relaxed mt-4">
              Engineering Intelligence Unit. Built for the future of decentralized computing and high-fidelity interfaces.
            </p>
            <FooterSocials className="mt-8">
              <Button variant="outline" size="icon" className="rounded-full"><Github size={16}/></Button>
              <Button variant="outline" size="icon" className="rounded-full"><Linkedin size={16}/></Button>
              <Button variant="outline" size="icon" className="rounded-full"><Twitter size={16}/></Button>
            </FooterSocials>
          </FooterSection>
        ...
        <FooterBottom>
          <div className="flex flex-col gap-2">
            <span className="text-xs font-black uppercase tracking-widest opacity-40">© 2026 AAZUCENA_LABS</span>
            <span className="text-[9px] font-mono opacity-20">BUILD_UUID: 0x7F42_ACTIVE</span>
          </div>
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <Activity size={12} className="text-emerald-500 animate-pulse" />
              <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500/60">System_Operational</span>
            </div>
            <FooterTechStack>
              <Globe size={14} className="opacity-40" />
              <span className="text-[9px] font-bold opacity-40 uppercase tracking-tighter">Distributed_Edge_Network</span>
            </FooterTechStack>
          </div>
        </FooterBottom>
      </FooterContent>
      ...
      <FooterContent>
        <FooterGrid>
          <FooterSection className="col-span-2">
            <h2 className="text-3xl font-black tracking-tighter uppercase mb-4 italic text-cyan-500">// AAZUCENA_LYTICS</h2>
            <p className="font-mono text-xs text-cyan-500/40 max-w-md">
              CENTRAL_INTELLIGENCE_UPLINK_ESTABLISHED<br/>
          ...
          <FooterSection>
            ...
            <FooterNav>
              <FooterLink href="#" className="font-mono text-cyan-500/60 hover:text-cyan-400 italic">{'>'} INIT_SYNC</FooterLink>
              <FooterLink href="#" className="font-mono text-cyan-500/60 hover:text-cyan-400 italic">{'>'} FLUSH_BUFFER</FooterLink>
              <FooterLink href="#" className="font-mono text-cyan-500/60 hover:text-cyan-400 italic">{'>'} REBOOT_NODE</FooterLink>
            </FooterNav>
          </FooterSection>
          <FooterSection>
            <FooterHeader className="text-cyan-500">SECURITY</FooterHeader>
            <FooterNav>
              <FooterLink href="#" className="font-mono text-cyan-500/60 hover:text-cyan-400 italic">{'>'} AUTH_TRACE</FooterLink>
              <FooterLink href="#" className="font-mono text-cyan-500/60 hover:text-cyan-400 italic">{'>'} FIREWALL_LOGS</FooterLink>
            </FooterNav>
          </FooterSection>
        </FooterGrid>
        <FooterBottom className="border-cyan-500/10">
          <Badge variant="cyber">UPLINK_SECURE</Badge>
          <p className="font-mono text-[9px] text-cyan-500/20">FRAGMENTED_KNOWLEDGE_BASE // ALL_SIGNALS_TRACED</p>
        </FooterBottom>
      </FooterContent>
    </Footer>
  ),
...
export const GlassAtmospheric: Story = {
  ...
  render: (args) => (
    <div className="bg-gradient-to-tr from-indigo-600 via-blue-700 to-cyan-800 p-10 pt-40 rounded-t-[4rem] overflow-hidden relative">
      ...
      <Footer {...args} className="border-white/10 relative z-10 bg-transparent backdrop-blur-none border-none">
        <FooterContent className="pt-0">
          <FooterGrid>
            <FooterSection>
              <h3 className="text-white text-xl font-black uppercase tracking-tighter">Crystal_Layer</h3>
            ...
            <FooterSection>
              ...
              <FooterNav>
                <FooterLink href="#" className="text-white/80 hover:text-white">US_East</FooterLink>
                <FooterLink href="#" className="text-white/80 hover:text-white">EU_Central</FooterLink>
                <FooterLink href="#" className="text-white/80 hover:text-white">Asia_Pacific</FooterLink>
              </FooterNav>
            </FooterSection>
          </FooterGrid>
          <FooterBottom className="border-white/10">
            <span className="text-white/40 text-[9px] font-bold uppercase tracking-widest">Atmospheric_Unit // 2026</span>
