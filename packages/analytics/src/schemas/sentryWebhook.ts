 ...
 * Minimal schema for Sentry issue event webhook payloads
 * Focuses on extracting fields relevant to the ClickHouse error_traces table
 */

// Sentry webhook payload validation
