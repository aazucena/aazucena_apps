import { z } from 'zod';
import { SkillCategoryVariantEnum, CategoryDisplayEnum } from '@aazucena/types';
...
export type StrapiSkillCategoriesResponse = z.infer<typeof StrapiSkillCategoriesResponseSchema>;
