...
export function AskMeAbout({ topics, className }: AskMeAboutProps): JSX.Element | null {
  if (!topics || topics.length === 0) return null;

  return (
    <div
      className={cn(
        'group relative overflow-hidden rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-6 dark:border-blue-800 dark:from-blue-900/20 dark:to-indigo-900/20 print:break-inside-avoid',
        className,
      )}
    >
      ...
      <div className="relative z-10">
        ...
        <p className="mb-4 text-sm leading-relaxed text-blue-700 dark:text-blue-300">
          Want to dive deeper? I'd love to chat about these specific challenges I tackled in this
          role:
        </p>
