...
export const LoadingState = memo(function LoadingState({
  ...
  const progressStyle = themeStyles.getProgressStyle(progress);
      ...
      <div className="space-y-4">
        ...
        <div className="relative mx-auto h-20 w-20" aria-hidden="true">
          {hasReached100 ? (
            <>
              <LoadingCircle
                className="flex h-20 w-20 animate-pulse animate-spin items-center justify-center"
        ...
        <div className="space-y-2">
          ...
          {hasReached100 && (
            <p className="text-center text-sm" style={themeStyles.getIconStyle('success')}>
