...
const chatShimmerVariants = cva('relative overflow-hidden rounded-md bg-muted animate-shimmer', {
  variants: {
    variant: {
      default: 'bg-muted',
      glass: 'glass-shimmer',
...
export interface ChatShimmerProps
  extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof chatShimmerVariants> {}
