...
export function EducationItem({ edu, duration, className }: EducationItemProps) {
  ...
  return (
    <div
      className={cn(
        'relative border-l-2 border-gray-100 pb-8 pl-8 last:pb-0 dark:border-gray-800',
        className,
      )}
    >
      {/* Timeline Node */}
      ...
      <div className="group cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>
        <div className="mb-2 flex flex-col justify-between gap-4 md:flex-row md:items-start">
          <div className="space-y-1">
            ...
            <p className="text-sm font-bold text-blue-600 dark:text-blue-400">{edu.institution}</p>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <div className="flex items-center gap-1.5 rounded-full border border-gray-100 bg-gray-50 px-3 py-1 text-[10px] font-black tracking-widest text-gray-500 uppercase dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400">
                ...
                {edu.graduationDate ? formatEduDate(edu.graduationDate) : 'Present'}
              </div>
              {duration && (
