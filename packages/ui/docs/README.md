...
Complete reference for the aazucena Component Intelligence Library.

---

## Quick Start

- **[Component Catalog](./component-catalog.md)** - Complete reference for all 93 components
- **[Theming Guide](./theming-guide.md)** - OKLCH customization and dark mode
- **[Composition Patterns](./composition-patterns.md)** - Building complex UIs from primitives
...
- **Component Library**: [Main README](../README.md)
- **Storybook**: Run `pnpm dev` in packages/ui
- **Design System**: [Tokens & Guidelines](../../design-system/docs/)
- **Source Code**: [src/components/](../src/components/)
