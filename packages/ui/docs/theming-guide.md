...
--primary-300: oklch(80% 0.1 250);
--primary-400: oklch(70% 0.15 250);
--primary-500: oklch(60% 0.2 250); /* Base */
--primary-600: oklch(50% 0.2 250);
--primary-700: oklch(40% 0.18 250);
--primary-800: oklch(30% 0.15 250);
--primary-900: oklch(20% 0.1 250);
...
/* Light mode */
.button-primary {
  background: oklch(60% 0.2 250); /* primary-500 */
}

/* Dark mode */
.dark .button-primary {
  background: oklch(70% 0.2 250); /* Lighter, more visible */
}
```
...
.hero-background {
  background: oklch(50% 0.2 250); /* Full chroma */
}

/* Dark mode background */
.dark .hero-background {
  background: oklch(20% 0.1 250); /* Reduced chroma, less eye strain */
}
```
...
/* Light mode */
.text-primary {
  color: oklch(10% 0 0); /* neutral-950 */
}

/* Dark mode */
.dark .text-primary {
  color: oklch(95% 0 0); /* neutral-50 */
}
```
...
.gradient-primary-radial {
  background: radial-gradient(
    circle at 50% 50%,
    oklch(60% 0.2 250 / 0.2) 0%,
    oklch(60% 0.2 250 / 0) 70%
  );
}

.gradient-hero {
  background: linear-gradient(135deg, oklch(60% 0.2 250) 0%, oklch(65% 0.18 45) 100%);
}
```
...
:root[data-theme='cyber'] {
  --primary-500: oklch(60% 0.2 250); /* High chroma cyan */
