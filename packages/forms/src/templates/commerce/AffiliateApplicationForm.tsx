...
import { affiliateApplicationSchema, type AffiliateApplicationFormData } from '../../schemas/index.js';
...
const PROMOTION_OPTIONS = ['blog_post', 'video', 'social_media', 'email_newsletter', 'podcast', 'other'];
const PROMOTION_LABELS: Record<string, string> = {
  blog_post: 'Blog Post', video: 'Video', social_media: 'Social Media',
  email_newsletter: 'Email Newsletter', podcast: 'Podcast', other: 'Other',
};
                    ...
                    {PROMOTION_OPTIONS.map((m) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() => {
                            const next = isSelected ? selected.filter((x) => x !== m) : [...selected, m];
