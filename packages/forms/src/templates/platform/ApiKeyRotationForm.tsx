...
import { apiKeyRotationSchema, type ApiKeyRotationFormData } from '../../schemas/index';
  ...
  return (
    ...
    >
      ...
      <div className="rounded-md border border-destructive/30 bg-destructive/5 p-3 text-xs text-destructive">
        <strong>Warning:</strong> This action cannot be undone. The old key will stop working after
