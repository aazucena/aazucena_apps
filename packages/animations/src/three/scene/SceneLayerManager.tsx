...
function SceneLayerManagerComponent({
  ...
  return (
    <>
      ...
      {opacities.thermosphere > 0 && <Thermosphere opacity={opacities.thermosphere} />}

      {/* Mesosphere Layer - Meteors and middle atmosphere */}
      {opacities.mesosphere > 0 && <Mesosphere opacity={opacities.mesosphere} />}
 ...
 */
export const SceneLayerManager = memo(SceneLayerManagerComponent, (prevProps, nextProps) => {
