...
import type { LayerObjects } from '@aazucena/types';
...
export const mesosphereObjects: LayerObjects = {
  easterEggs: [
    ...
    // Space debris pieces
    {
      ...
      position: [-2 + Math.random() * 1, 1 + Math.random() * 1, -9 + Math.random() * 1] as [
        number,
        number,
        number,
      ],
    ...
    },
    {
      ...
      type: 'space-debris' as const,
      category: 'easter-egg' as const,
      position: [1 + Math.random() * 1, -2 + Math.random() * 1, -11 + Math.random() * 1] as [
        number,
        number,
        number,
      ],
    ...
    },
    {
      ...
      type: 'space-debris' as const,
      category: 'easter-egg' as const,
      position: [-1 + Math.random() * 1, 0 + Math.random() * 1, -10 + Math.random() * 1] as [
        number,
        number,
        number,
      ],
    ...
    },
    {
      ...
      type: 'space-debris' as const,
      category: 'easter-egg' as const,
      position: [2 + Math.random() * 1, 1.5 + Math.random() * 1, -8 + Math.random() * 1] as [
        number,
        number,
        number,
      ],
