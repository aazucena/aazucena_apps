...
import type { PixiParticle, ParticleEmitterConfig } from '@aazucena/types';

export class ParticleEmitter {
  private config: ParticleEmitterConfig;
  private particlePool: PixiParticle[] = [];
  private activeParticles: PixiParticle[] = [];
   ...
   */
  emit(x: number, y: number, count: number = 1): PixiParticle[] {
    const newParticles: PixiParticle[] = [];
   ...
   */
  private createParticle(x: number, y: number, burstCount: number = 1): PixiParticle {
   ...
   */
  private createNewParticle(): PixiParticle {
    return {
      x: 0,
      y: 0,
      vx: 0,
   ...
   */
  getActiveParticles(): PixiParticle[] {
