...
Complete reference for the aazucena Utility Intelligence System.

---

## Quick Start

- **[Utility Catalog](./utility-catalog.md)** - Complete reference for all 33 utility modules
- **[Best Practices](./best-practices.md)** - Performance optimization, tree-shaking, when to use utils vs hooks
